...
const transcribe = async (
    ...
    // FORCE TINY MODEL for maximum speed and lightweight performance
    let modelName = FORCE_TINY_MODEL ? TINY_MODEL : model;

    if (!isDistilWhisper && !multilingual && !FORCE_TINY_MODEL) {
        modelName += ".en"
    }
